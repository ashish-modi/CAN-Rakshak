...
def process_multiple_images(image_folder):
    ...
    # if input_images == "dos_k12":
    #     image_folder = r"perturbed_images_dos"
    # elif input_images == "test/perturbed_dos":
    #     image_folder = r"test/perturbed_dos"
    # else:
...
def run(params):
    ...
    print(f"Saved decoded_traffic_dos_CH/traffic_{rounds}.txt")
